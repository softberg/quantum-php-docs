...
If you are evaluating the framework, continue with [Why Quantum PHP Framework?](why-quantum.md).

If you are ready to try it, go to [Installation](../installation.md).
